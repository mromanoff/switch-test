<template>
  <svg style="display: none;" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ...
      <symbol id="checkboxMarked" viewBox="0 0 24 24">
        <path d="M10,17L5,12L6.41,10.58L10,14.17L17.59,6.58L19,8M19,3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3Z" />
      </symbol>

      <symbol id="radioboxBlank" viewBox="0 0 24 24">
        <path d="M12 20a8 8 0 0 1-8-8 8 8 0 0 1 8-8 8 8 0 0 1 8 8 8 8 0 0 1-8 8m0-18A10 10 0 0 0 2 12a10 10 0 0 0 10 10 10 10 0 0 0 10-10A10 10 0 0 0 12 2z" />
      </symbol>

      <symbol id="radioboxMarked" viewBox="0 0 24 24">
        <path
      ...
      <symbol id="menuDown" viewBox="0 0 24 24">
        <path d="M7,10L12,15L17,10H7Z" />
      </symbol>

      <symbol id="menuUp" viewBox="0 0 24 24">
      ...
      <symbol id="playCircle" viewBox="0 0 24 24">
        <path d="M10,16.5V7.5L16,12M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z" />
      </symbol>

      <symbol id="priceDollar" viewBox="0 0 24 24">
        <path
      ...
      <symbol id="profileCard" viewBox="0 0 24 24">
        <path
      ...
      <symbol id="speedometer" viewBox="0 0 24 24">
        <path
      ...
      <symbol id="starHalf" viewBox="0 0 24 24">
        <path
      ...
      <symbol id="starOutline" viewBox="0 0 24 24">
        <path
      ...
      <symbol id="colorOptions" viewBox="0 0 24 24">
        <circle cx="11.97" cy="8.41" r="4.1" fill="#f78f41" />
        <circle cx="7.87" cy="15.59" r="4.1" fill="#398bd3" />
        <circle cx="16.13" cy="15.59" r="4.1" fill="#4db45d" />
      </symbol>

      <symbol id="expertReview" viewBox="0 0 24 24">
        <path
